 ...
 * Generated at: 2017-05-08 10:36:12 UTC
...
public final class Registration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"InputName\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"InputName\" placeholder=\"Enter Name\" required> <span\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"email\" class=\"form-control\" id=\"InputEmailFirst\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"InputEmail\" placeholder=\"Enter Email\" required>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"InputEmail\">Enter Password</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"password\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"password\" placeholder=\"password\" required> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"input-group-addon\"><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-asterisk\"></span></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
